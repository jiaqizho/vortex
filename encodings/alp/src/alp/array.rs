...
impl VTable for ALP {
    ...
    fn plan_range_read(
        ...
        let child_dtype = match dtype {
            DType::Primitive(PType::F32, nullability) => DType::Primitive(PType::I32, *nullability),
            DType::Primitive(PType::F64, nullability) => DType::Primitive(PType::I64, *nullability),
            _ => return Ok(None),
        };
